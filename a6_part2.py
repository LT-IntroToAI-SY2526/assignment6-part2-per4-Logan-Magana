...
def visualize_features(data):
    ...
    plt.savefig('features_plots.png', dpi=300, bbox_inches='tight')
    # TODO: Show the plot
    print("\n✓ Feature plots saved as 'features_plots.png'")
    plt.show()
...
def make_prediction(model, sqft, bedrooms, bathrooms, age):
    ...
    print(f"\n=== New Prediction ===")
    print(f"House specs: {sqft:.0f} SquareFeet, {age} years old, {bedrooms} bedrooms, {bathrooms} bathrooms")
...
if __name__ == "__main__":
    ...
    make_prediction(model, 1850, 2, 2, 10)  
